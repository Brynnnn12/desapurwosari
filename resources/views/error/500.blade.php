...
<body>
    ...
    <div class="bg-gray-100 h-screen justify-center">
        <center class="mt-24 m-auto">
            <svg class="500 " enable-background="new 0 0 226 249.135" height="249.135" id="Layer_1" overflow="visible"
        ...
        <center class="mt-6">
            <a href="/" class="text-gray-500 font-mono text-xl bg-gray-200 p-3 rounded-md hover:shadow-md">Go back
            </a>
        </center>
    </div>
